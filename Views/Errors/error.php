...
<body>
    ...
    <div class="auth-page-wrapper pt-5">
        <!-- auth page bg -->
        <div class="auth-bg-position auth-one-bg" id="auth-particles">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center pt-4">
                            <div class="">
                                <img src="public/images/error.svg" alt="" class="error-basic-img move-animation">
                            </div>
                            <div class="mt-n4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Jipsafety. Equipos de seguridad
                            </p>
                        </div>
                    </div>
                </div>
