<!--MODAL PRESENTACION-->
<div id="modalPresentacion" class="modal zoomIn" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form method="post" id="formPresentacion" name="formPresentacion">

                    <input type="hidden" id="idPresentacion" name="idPresentacion" value="">
                    <div class="mb-3">
