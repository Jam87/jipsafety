<!--MODAL MONEDA-->
<div id="modalMoneda" class="modal zoomIn" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form method="post" id="formMoneda" name="formMoneda">

                    <input type="hidden" id="idMoneda" name="idMoneda" value="">
                    <div class="mb-3">
                        <label for="Nombre" class="form-label">Nombre <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="txtName" name="txtName" placeholder="Escriba nueva moneda" required>
                    </div><!--Fin nombre-->
                    <div class="mb-3">
