                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button type="button" id="btnnuevo" class="btn btn-primary btn-label waves-effect waves-light rounded-pill" onclick="openModal();"><i class="ri-user-smile-line label-icon align-middle rounded-pill fs-16 me-2"></i><?= $data['btn_title_principal']; ?></button>
                                </div>
                                <div class="card-body">
                                    <!-- Tabla de Tipo de usuario -->
                                    <table id="table-usuarios" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Teléfono</th>
