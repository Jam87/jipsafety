...
function Holder_Text()
{
    $('input[type=text], input[type=tel], input[type=email]').each(function (e) {

        var clase = $(this).attr("class");

        if (clase !== "search" && clase !== "nomarignb" && clase !== "col4" && clase !== "datatable-filter datatable-input-text form-control" && clase !== "nolabel" && clase !== "aspNetDisabled nolabel" && clase !== "numeric nolabel" && clase !== "datepicker nolabel") {
