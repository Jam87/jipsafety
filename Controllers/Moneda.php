    ...
    public function getMoneda()
    {
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            if ($arrData[$i]['es_local'] == 1) {
                $arrData[$i]['es_local'] = '<img id="header-lang-img" src="https://jip.grupopaniagua.com/assets/images/flags/germany.svg" alt="Header Language" height="20" class="rounded"><span> Nacional</span>';
            } else {
